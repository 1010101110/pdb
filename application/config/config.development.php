...
//for production (logs errors instead of displaying them)
...
return array(
	...
	'IMG_URL' => 'https://' . $_SERVER['HTTP_HOST'] . str_replace('public', '', dirname($_SERVER['SCRIPT_NAME'])) . 'images/',
	/**
	...
	'PATH_AVATARS' => realpath(dirname(__FILE__).'/../../') . '/public/images/avatars',
	'PATH_AVATARS_PUBLIC' => 'images/avatars/',
	/**
	 ...
	 */
	'EMAIL_PASSWORD_RESET_URL' => 'user/verifypasswordreset',
	'EMAIL_PASSWORD_RESET_FROM_EMAIL' => 'no-reply@pepperdatabase.org',
	'EMAIL_PASSWORD_RESET_FROM_NAME' => 'PDB',
	'EMAIL_PASSWORD_RESET_SUBJECT' => 'Password reset for PepperDatabase',
	'EMAIL_PASSWORD_RESET_CONTENT' => "Oops forgot something...\n\nPlease click on this link to reset your password: ",
	'EMAIL_VERIFICATION_URL' => 'user/verify',
	'EMAIL_VERIFICATION_FROM_EMAIL' => 'no-reply@pepperdatabase.org',
	'EMAIL_VERIFICATION_FROM_NAME' => 'PDB',
	'EMAIL_VERIFICATION_SUBJECT' => 'Account activation for PepperDatabase',
	'EMAIL_VERIFICATION_CONTENT' => "Welcome to Pepper Database, One last step!\n\nPlease click on this link to activate your account: ",
);
