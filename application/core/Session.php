...
class Session
{
    ...
    //returns formatted usergroup!
    public static function getusergroup()
    {
        $accounttype = Session::get('user_account_type');
        $ret = "user not loaded";
    ...
    public static function getUserHistory($id = null)
    {
        if(isset($id))
        {
            return HistoryModel::getHistoryOfUser($id);            
        }
    }
}
